...
// In production the API/asset base follows the SvelteKit base path (empty by default,
// or e.g. /openwebui when built with WEBUI_BASE_PATH) so all requests are prefixed.
